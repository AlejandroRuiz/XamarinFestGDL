...
namespace Clima.Models
{
    ...
    public class ClimaRoot
    {
        ...
        public List<Clima> Weather { get; set; } = new List<Clima>();
        ...
        public double MaxTemp => MainWeather.MaxTemperature;
        public double MinTemp => MainWeather.MinTemperature;
        public double Pression => MainWeather.Pressure;
        public double Humidity => MainWeather.Humidity;
        public double Temperatura => MainWeather.Temperature;
    ...
    public class WeatherForecastRoot
    {
        ...
        [JsonProperty("list")]
        public List<ClimaRoot> Items { get; set; }
